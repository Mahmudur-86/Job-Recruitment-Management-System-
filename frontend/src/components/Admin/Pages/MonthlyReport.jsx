                    ...
                    {!loading &&
                      rows.map((r, idx) => (
                        <tr key={`${r.jobId}-${idx}`} className="border-t hover:bg-gray-50 align-top">
                          ...
                          <td className="text-center px-3 py-3 whitespace-nowrap"> {r.recruitmentLetterStatus || "Not Sent"}</td>
                          <td className="text-center px-3 py-3 whitespace-nowrap">{r.emailStatus || "Not Sent"}</td>
                          <td className="text-left px-3 py-3 whitespace-normal wrap-break-word">{r.emailTo || "-"}</td>
                        </tr>
                      ))}
                    {!loading && sum ? (
